...
function NotificationsContainer() {
  const [{ notificationShow, orders, user }, dispatch] = useStateValue();
  ...
  useEffect(() => {
    ...
    //     setWorkItemsID([...workItemsID, workItemID]);
    //   }
    ...
    //   //       const data = item?.filter(item1 => item1.userDetails.email === currentUserEmail);
  ...
  console.log("workItems 2", workItemsID)
  ...
  return (
    ...
    >
      ...
      {/* bottom section */}
      {workItemsID && workItemsID.length > 0 && orders && orders.length > 0 ? (
