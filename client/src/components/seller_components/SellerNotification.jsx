...
function SellerNotification({ item, setFlag, flag }) {
    ...
    useEffect(() => {
      if (orderUserEmail === currentUserEmail) {
        ...
        console.log("work item from seller notification", workItemData)
  ...
  return (
    ...
    <div className="w-full p-1 px-2 rounded-lg bg-gray-100 flex items-center gap-2">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm block text-gray-900 font-semibold"> {workItemData && <p>You have new order.</p>}</p>
      </div>
